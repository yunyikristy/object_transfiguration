import sys
sys.path.insert(0, '/home/v-shuama/workspace/caffe-tensorflow/')
import numpy
...
class GoogleNet(Network):
    def setup(self):
        ...
        (self.feed('inception_4a_output')
             ...
             .fc(1024, relu=True, name='loss1_fc')
             #.dropout(0.7, name="loss1_dropout")
             .fc(200, relu=False, name='loss1_classifier'))
        #
        ...
        (self.feed('inception_4d_output')
             ...
             .fc(1024, relu=True, name='loss2_fc')
             #.dropout(0.7, name="loss2_dropout")
             .fc(200, relu=False, name='loss2_classifier'))
        #
...
class AppEncoder:
    ...
    def build(self, rgb):
        ...
        bgr = tf.concat(3, [b - MEAN[0], g - MEAN[1], r - MEAN[2]])
        bgr = tf.image.resize_images(bgr, (224, 224))

        self.net = GoogleNet({'data':bgr})
        layers = self.net.layers
        out = layers['pool5_7x7_s1']
